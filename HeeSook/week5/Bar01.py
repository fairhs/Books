...
#print(Cs)
grouped = df.groupby(['CLASS','ORGYN'])['ORGANICS'].count()
b= grouped.plot.bar()

plt.show()

grouped = df.groupby(['NGROUP','CLASS'])['ORGANICS'].count()
b= grouped.plot.bar()

plt.show()


grouped = df.groupby(['GENDER','CLASS'])['ORGANICS'].count()
b= grouped.plot.bar()
...
grouped = df.groupby(['TV_REG','CLASS'])['ORGANICS'].count()
b= grouped.plot.bar()
...
grouped = df.groupby(['CLASS','GENDER'])['NEIGHBORHOOD'].count()
b= grouped.plot.bar()
